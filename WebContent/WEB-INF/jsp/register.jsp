...
<h3 align="center">${message}, Click here to <a href="${pageContext.request.contextPath}/login">login</a></h3>
</c:if>
<c:if test='${empty message}'>
<h3 align="center">Already have an account, Click here to <a href="${pageContext.request.contextPath}/login">login</a></h3>
</c:if>
<div id="wrapper">
